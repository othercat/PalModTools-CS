...
public static unsafe class Base
{
    ...
    public struct CShop
    {
        public  fixed   ushort      Items[MaxShopItem];
    }
    ...
    public struct CHeroMagic
    {
        ...
        const   short       _lenLow     = MaxHero;
        const   short       _lenHigh    = MaxHeroMagic;
    ...
    public struct CHero
    {
        ...
        public  fixed   short               CooperativeMagic[MaxHero];      // 合体法术
