    ...
    public static void Process()
    {
        ...
        for (i = (int)EntityBeginId.Hero, j = 0; i < end; i++, j++)
        {
            ...
            for (k = 0; k < magicLearned.Length; k++)
                magicLearned[k] = Config.GetSoftMagicId(pBase->Magic[j, k]);
            ...
            for (k = 0; k < count; k++)
            {
                ...
                if (pThisMagic->MagicId != 0)
                    magicLearnable.Add(new(
                        ...
                        MagicId: Config.GetSoftMagicId(pThisMagic->MagicId)
                    ));
            }
            ...
            hero = new RGame.Hero(
                ...
                Magic: new(
                    Cooperative: Config.GetSoftMagicId(pBase->CooperativeMagic[j]),
