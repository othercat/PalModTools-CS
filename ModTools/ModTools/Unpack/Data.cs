...
public static unsafe class Data
{
    ...
    public static void Process()
    {
        ...
        //
        {
            short GetEnemyEntityId(short hardEnemyId) => (hardEnemyId == -1 || hardEnemyId == 0) ? hardEnemyId : (short)(hardEnemyId - (short)Records.Pal.Entity.BeginId.Enemy + 1);
            ...
            for (i = 0; i < len; i++)
            {
                for (j = 0; j < enemyTeam.Length; j++)
                    enemyTeam[j] = GetEnemyEntityId(pEnemyTeam[i].EnemyIds[j]);
