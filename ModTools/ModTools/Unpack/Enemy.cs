    ...
    public static void Process()
    {
        ...
        for (i = (int)EntityBeginId.Enemy, id = 1; i < end; i++, id++)
        {
            ...
            enemy = new RGame.Enemy(
                ...
                MagicId: Config.GetSoftMagicId(pThisBase->MagicId),
                MagicRate: pThisBase->MagicRate,
                AttackEquivItemId: Config.GetSoftEntityId(Type.Item, pThisBase->AttackEquivItemId),
                AttackEquivItemRate: pThisBase->AttackEquivItemRate,
                StealItemId: Config.GetSoftEntityId(Type.Item, pThisBase->StealItemId),
